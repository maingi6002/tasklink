document.addEventListener('DOMContentLoaded', function () {
  ...
  var JOBS = [
    ...
    { id: 34, title: 'Watch & Rate Short Ads', company: 'AdVibe', salary: '$1-3/day', location: 'Remote (Phone)', type: 'Freelance', posted: 'Today', category: 'Data & Analytics', experience: 'Entry Level', fee: 0, feeLabel: '', description: 'Watch 30-60 second advertisements and rate them based on clarity, engagement, and appeal. Perfect for doing while commuting — just tap and rate. No typing needed.' },
    { id: 35, title: 'Product Review Comments', company: 'ReviewBooth', salary: '$2-5/day', location: 'Remote (Phone)', type: 'Freelance', posted: 'Today', category: 'Marketing', experience: 'Entry Level', fee: 0, feeLabel: '', description: 'Read short product descriptions and leave 1-2 sentence reviews. All done from your phone. Great for nights in or lunch breaks. No experience needed.' },
    { id: 36, title: 'Photo Tagging & Categorizing', company: 'DataWorks', salary: '$3-8/day', location: 'Remote (Phone)', type: 'Freelance', posted: '1 day ago', category: 'Data & Analytics', experience: 'Entry Level', fee: 0, feeLabel: '', description: 'Tap through images and tag objects, people, or scenes. Helps train AI models. Simple swiping and tapping — works great on any smartphone.' },
    { id: 37, title: 'Voice Recording for Apps', company: 'SpeechLab', salary: '$5-15/week', location: 'Remote (Phone)', type: 'Freelance', posted: '1 day ago', category: 'Writing', experience: 'Entry Level', fee: 0, feeLabel: '', description: 'Read short sentences aloud into your phone\'s microphone. Help improve voice assistants. Do it while walking, cooking, or relaxing. Just tap record and speak.' },
    { id: 38, title: 'Short Survey Taker', company: 'PollVault', salary: '$1-4/hr', location: 'Remote (Phone)', type: 'Freelance', posted: '2 days ago', category: 'Data & Analytics', experience: 'Entry Level', fee: 0, feeLabel: '', description: 'Answer quick surveys on your phone about products, services, and daily habits. Most surveys take 2-5 minutes. Payout is instant. No computer needed.' },
    { id: 39, title: 'Social Media Engager', company: 'SocialPulse', salary: '$3-7/day', location: 'Remote (Phone)', type: 'Freelance', posted: '2 days ago', category: 'Marketing', experience: 'Entry Level', fee: 0, feeLabel: '', description: 'Like, share, and comment on brand social media posts. Follow simple guidelines and earn. All done from your phone\'s browser or apps. Great side hustle.' },
    { id: 40, title: 'App Tester (Basic Features)', company: 'Testify', salary: '$2-6/test', location: 'Remote (Phone)', type: 'Freelance', posted: '3 days ago', category: 'Software Development', experience: 'Entry Level', fee: 0, feeLabel: '', description: 'Download new apps, tap through their basic features, and report if anything breaks. No coding skills needed. Just use the app like a normal user on your phone.' },
    { id: 41, title: 'SMS Verification Helper', company: 'VerifyFast', salary: '$1-3/task', location: 'Remote (Phone)', type: 'Freelance', posted: '3 days ago', category: 'Customer Service', experience: 'Entry Level', fee: 0, feeLabel: '', description: 'Receive SMS verification codes for account registrations and forward them securely. Straightforward phone-based tasks. Takes seconds per task.' },
    { id: 42, title: 'Receipt Digitizer', company: 'ExpenseEase', salary: '$2-6/day', location: 'Remote (Phone)', type: 'Freelance', posted: '4 days ago', category: 'Data & Analytics', experience: 'Entry Level', fee: 0, feeLabel: '', description: 'Snap photos of receipts using your phone camera and enter the amounts into a simple form. No computer required. Perfect for downtime.' },
    { id: 43, title: 'Caption Writer for Reels', company: 'ClipCaption', salary: '$3-8/day', location: 'Remote (Phone)', type: 'Freelance', posted: '4 days ago', category: 'Writing', experience: 'Entry Level', fee: 0, feeLabel: '', description: 'Watch short video clips and write 1-2 line captions. All done from your phone. Great for creative people who love scrolling through videos anyway.' },
    { id: 44, title: 'Map Pin Verifier', company: 'MapRight', salary: '$2-5/day', location: 'Remote (Phone)', type: 'Freelance', posted: '5 days ago', category: 'Data & Analytics', experience: 'Entry Level', fee: 0, feeLabel: '', description: 'Check if business locations on the map are correct by viewing street-level imagery. Tap to confirm or correct. Works entirely on your phone.' },
    { id: 45, title: 'Music Mood Tagger', company: 'TuneTag', salary: '$1-4/day', location: 'Remote (Phone)', type: 'Freelance', posted: '5 days ago', category: 'Data & Analytics', experience: 'Entry Level', fee: 0, feeLabel: '', description: 'Listen to 15-30 second music clips and tag the mood (happy, sad, energetic, calm). Do it while relaxing with earphones. Simple tap-to-tag interface.' },
    { id: 46, title: 'Mystery Shopper Feedback', company: 'ShopCheck', salary: '$3-10/report', location: 'Remote (Phone)', type: 'Freelance', posted: '1 week ago', category: 'Customer Service', experience: 'Entry Level', fee: 0, feeLabel: '', description: 'Visit a local shop (or browse an online store) and answer a few questions about your experience. Submit via a short form on your phone. No writing required.' },
    { id: 47, title: 'Emoji-Based Sentiment Rater', company: 'MoodMetrix', salary: '$1-3/day', location: 'Remote (Phone)', type: 'Freelance', posted: '1 week ago', category: 'Data & Analytics', experience: 'Entry Level', fee: 0, feeLabel: '', description: 'Rate customer service chats, product descriptions, or social posts using only emojis. No typing. No reading long texts. Just tap an emoji and move on.' }
  ];
  window.JOBS = JOBS;
