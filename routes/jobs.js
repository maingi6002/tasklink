...
const DEFAULT_JOBS = [
  ...
  { id: 34, title: 'Watch & Rate Short Ads', company: 'AdVibe', salary: '$1-3/day', location: 'Remote (Phone)', type: 'Freelance', posted: 'Today', category: 'Data & Analytics', experience: 'Entry Level', fee: 0, feeLabel: '' },
  { id: 35, title: 'Product Review Comments', company: 'ReviewBooth', salary: '$2-5/day', location: 'Remote (Phone)', type: 'Freelance', posted: 'Today', category: 'Marketing', experience: 'Entry Level', fee: 0, feeLabel: '' },
  { id: 36, title: 'Photo Tagging & Categorizing', company: 'DataWorks', salary: '$3-8/day', location: 'Remote (Phone)', type: 'Freelance', posted: '1 day ago', category: 'Data & Analytics', experience: 'Entry Level', fee: 0, feeLabel: '' },
  { id: 37, title: 'Voice Recording for Apps', company: 'SpeechLab', salary: '$5-15/week', location: 'Remote (Phone)', type: 'Freelance', posted: '1 day ago', category: 'Writing', experience: 'Entry Level', fee: 0, feeLabel: '' },
  { id: 38, title: 'Short Survey Taker', company: 'PollVault', salary: '$1-4/hr', location: 'Remote (Phone)', type: 'Freelance', posted: '2 days ago', category: 'Data & Analytics', experience: 'Entry Level', fee: 0, feeLabel: '' },
  { id: 39, title: 'Social Media Engager', company: 'SocialPulse', salary: '$3-7/day', location: 'Remote (Phone)', type: 'Freelance', posted: '2 days ago', category: 'Marketing', experience: 'Entry Level', fee: 0, feeLabel: '' },
  { id: 40, title: 'App Tester (Basic Features)', company: 'Testify', salary: '$2-6/test', location: 'Remote (Phone)', type: 'Freelance', posted: '3 days ago', category: 'Software Development', experience: 'Entry Level', fee: 0, feeLabel: '' },
  { id: 41, title: 'SMS Verification Helper', company: 'VerifyFast', salary: '$1-3/task', location: 'Remote (Phone)', type: 'Freelance', posted: '3 days ago', category: 'Customer Service', experience: 'Entry Level', fee: 0, feeLabel: '' },
  { id: 42, title: 'Receipt Digitizer', company: 'ExpenseEase', salary: '$2-6/day', location: 'Remote (Phone)', type: 'Freelance', posted: '4 days ago', category: 'Data & Analytics', experience: 'Entry Level', fee: 0, feeLabel: '' },
  { id: 43, title: 'Caption Writer for Reels', company: 'ClipCaption', salary: '$3-8/day', location: 'Remote (Phone)', type: 'Freelance', posted: '4 days ago', category: 'Writing', experience: 'Entry Level', fee: 0, feeLabel: '' },
  { id: 44, title: 'Map Pin Verifier', company: 'MapRight', salary: '$2-5/day', location: 'Remote (Phone)', type: 'Freelance', posted: '5 days ago', category: 'Data & Analytics', experience: 'Entry Level', fee: 0, feeLabel: '' },
  { id: 45, title: 'Music Mood Tagger', company: 'TuneTag', salary: '$1-4/day', location: 'Remote (Phone)', type: 'Freelance', posted: '5 days ago', category: 'Data & Analytics', experience: 'Entry Level', fee: 0, feeLabel: '' },
  { id: 46, title: 'Mystery Shopper Feedback', company: 'ShopCheck', salary: '$3-10/report', location: 'Remote (Phone)', type: 'Freelance', posted: '1 week ago', category: 'Customer Service', experience: 'Entry Level', fee: 0, feeLabel: '' },
  { id: 47, title: 'Emoji-Based Sentiment Rater', company: 'MoodMetrix', salary: '$1-3/day', location: 'Remote (Phone)', type: 'Freelance', posted: '1 week ago', category: 'Data & Analytics', experience: 'Entry Level', fee: 0, feeLabel: '' }
];
